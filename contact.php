    ...
    <footer class="border1" style="height: 450px; background-color: #000; color: #fff; padding-top: 60px;">
        ...
        <div class="container">
            ...
            <div class="box2" style="margin-left: 60px;">
                <ul class="ul2">
                    <li class="mb-3 d-inline-block resize"><a id="link1" href="business.html">Business</a></li>
                    <li class="mb-3 d-inline-block resize"><a id="link1" href="about.html">About</a></li>
                    <li class="mb-3 d-inline-block resize"><a id="link1" href="services.html">Services</a></li>
                    <li class="mb-3 d-inline-block resize resize1"><a id="link3" href="contact.php">Contact Us</a></li>
                </ul>
            </div>
        </div>
        <!-- THE END -->
